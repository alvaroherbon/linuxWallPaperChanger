...
from .window import LinuxwallpaperchangerWindow


class LinuxwallpaperchangerApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='org.gnome.linuxWallpaperChanger',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS)

        self.settings = Gio.Settings(schema_id="org.gnome.linuxWallpaperChanger")
        ...
        dark_mode_action = Gio.SimpleAction(name="dark-mode",state=GLib.Variant.new_boolean(False))
    ...
    def do_activate(self):
        ...
        if not win:
            win = LinuxwallpaperchangerWindow(application=self)
        win.present()
...
def main(version):
    ...
    app = LinuxwallpaperchangerApplication()
